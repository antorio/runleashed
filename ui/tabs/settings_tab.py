...
def settings_tab():
    ...
    with gr.Tab("⚙ Settings"):
        ...
        gr.Markdown("Global preferences — applied to every swap.", elem_classes="rl-sub")
        with gr.Row():
            # ---- left column: Performance + Output ----
            with gr.Column():
                with gr.Column(elem_classes="rl-card"):
                    gr.Markdown("Performance · how hard your machine works", elem_classes="rl-section-title")
                ...
                with gr.Column(elem_classes="rl-card"):
                    gr.Markdown("Output · how finished files are written", elem_classes="rl-section-title")
            ...
            # ---- right column: Expression restorer + Interface & maintenance ----
            with gr.Column():
                with gr.Column(elem_classes="rl-card"):
                    with gr.Row():
                        gr.Markdown("Expression restorer · LivePortrait global tuning", elem_classes="rl-section-title")
                        gr.Markdown("live · no restart", elem_classes="rl-badge-ok")
                    gr.Markdown("Pose lock", elem_classes="rl-sub")
                    with gr.Row():
                        expr_global_controls = []
                        expr_global_controls.append(gr.Checkbox(label="Translation", value=roop.globals.expression_pose_lock, elem_id='expression_pose_lock', interactive=True))
                        expr_global_controls.append(gr.Checkbox(label="Scale", value=roop.globals.expression_pose_lock_scale, elem_id='expression_pose_lock_scale', interactive=True))
                        expr_global_controls.append(gr.Checkbox(label="Rotation", value=roop.globals.expression_pose_lock_rotation, elem_id='expression_pose_lock_rotation', interactive=True))
                    gr.Markdown("Pipeline", elem_classes="rl-sub")
                    with gr.Row():
                ...
                with gr.Column(elem_classes="rl-card"):
                    gr.Markdown("Interface & maintenance", elem_classes="rl-section-title")
