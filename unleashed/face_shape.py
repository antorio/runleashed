...
def landmarks3d(face):
    ...
    landmark_3d_68_buffalo (unleashed/landmark68.py)."""
...
def _landmark_model():
    ...
    try:
        ...
        if m is None:
            ...
            providers = ['CPUExecutionProvider'] if unleashed.globals.CFG.force_cpu else unleashed.globals.execution_providers
