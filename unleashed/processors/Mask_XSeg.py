...
class Mask_XSeg():
    ...
    def Initialize(self, plugin_options:dict):
        ...
        if self.model_xseg is None:
            ...
            self.model_xseg = onnxruntime.InferenceSession(model_path, None, providers=__import__('unleashed.utilities',fromlist=['tuned_execution_providers']).tuned_execution_providers())
